const CACHE = "pose-cognitive-trainer-v1.0.3";
...
const APP_FILES = ["./", "./index.html", "./styles.css?v=1.0.3", "./app.js?v=1.0.3", "./core.mjs", "./manifest.webmanifest", "./icons/icon.svg", "./icons/icon-192.png", "./icons/icon-512.png", "./icons/icon-maskable-512.png", "./icons/apple-touch-icon.png", ...AUDIO_FILES];
