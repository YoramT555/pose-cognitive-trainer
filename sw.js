const CACHE = "pose-cognitive-trainer-v1.0.1";
...
const APP_FILES = ["./", "./index.html", "./styles.css?v=1.0.1", "./app.js?v=1.0.1", "./core.mjs", "./manifest.webmanifest", "./icons/icon.svg", ...AUDIO_FILES];
